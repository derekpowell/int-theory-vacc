...
# compute_scoretables <- FALSE # uncomment or set to TRUE to recompute scoretables
source("../scripts/custom-structure-learning/fit-cog-models.R", chdir=TRUE)

## NOTE: make sure to fix to recompute all 5
```
...
saveRDS(all_results, "../local/allresults.rds")
