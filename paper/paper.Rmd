...
To examine this possibility, we invited participants from Study 1 (conducted in August-September 2017) to participate in a new study measuring each of those 14 beliefs again (conducted on May 1st, 2019; approximately 18 months later). Of the `r results$s1$demo$n_include` participants in Study 1, `r results$s4$demo$n_complete` returned and completed the study. Approximately `r round(100*(results$s4$demo$n_news/results$s4$demo$n_complete),0) `% of participants reported recently seeing, hearing, or reading about measles outbreaks.
