...
Much of the richness of human thought is supported by people’s intuitive theories---explanatory mental frameworks that capture the perceived causal and relational structure of the world. But serious consequences can arise when these theories are mistaken, such as when they contain misconceptions about vaccine safety that discourage vaccination. We argue that addressing misconceptions requires awareness of the broader conceptual context in which they are embedded. Here, we examine the role of intuitive theories in misconceptions and belief revision by focusing on vaccine hesitancy as a case study. First, we developed a cognitive model of the intuitive theory surrounding vaccination decisions by identifying a set of relevant beliefs, surveying a large sample of U.S. adults, and applying Bayesian network structure learning algorithms to their responses (Study 1).Then, we applied this model to understand belief revision within this larger conceptual system. We found that our model helped to explain belief revision following an established educational intervention (Study 2), provided insight that supported our formulation of a novel educational intervention that successfully increased vaccination intentions (Studies 3a, 3b), and also helped to explain how people’s beliefs changed following real-world events (Study 4). Taken together, this work illustrates the promise of understanding belief revision in terms of intuitive theories and of discovering and formalizing intuitive theories via computational models. Moreover, it lays the foundation for theory-based educational interventions that could encourage people to vaccinate their children and themselves against dangerous diseases like measles and Covid-19.

## Significance Statement

When people decide whether to vaccinate their children and themselves against dangerous diseases like measles and Covid-19, their decisions are affected by a network of interrelated beliefs about specific diseases, vaccine safety and efficacy, the immune system, the medical system, and health and nature more generally. By creating a computational model of the intuitive theory connecting these different beliefs, we were able to make accurate predictions about how these beliefs are revised in light of educational interventions, design an effective new intervention encouraging vaccination, and understand how these beliefs were affected by real-world events. This approach provides the foundation for richer understandings of intuitive theories more broadly and sheds new light on long-standing theoretical questions about belief revision. 

\newpage

One remarkable feature of human psychology is our ability to form rich mental representations of what is true, how things work, and how best to navigate the world around us. Much of this type of thinking can be understood as deriving from people’s *intuitive theories*---explanatory frameworks, analogous to scientific theories, that capture the causal and logical structure of the world within a domain. From early in life, people are driven to seek out such causal explanations and to use their mental representations of these causal systems to explain, predict, and intervene in the world; and to make sense of new information and experiences [see @carey2009; @gelman.legare2011; @gerstenberg.etal2021; @gopnik.wellman1994; @keil1994; @murphy.medin1985; @wellman.gelman1992 for influential treatments of this topic].  Intuitive theories inform reasoning in a wide variety of domains, from reasoning about physical systems [e.g., @baillargeon2004; @battaglia.etal2013; @spelke1994a; @ullman.etal2017], to reasoning about biological processes [e.g., @carey1985; @carey2009; @medin.atran1999] and about the contents of other people’s minds [e.g., @gopnik.wellman1994; @wellman2015; @baker.etal2017].
...
How did this intervention---which focused solely on the dangers of childhood diseases---affect beliefs about *vaccine danger*, *medical skepticism*, *holistic balance*, and so on? One explanation is that this intervention provides direct evidence for *disease severity* beliefs and that other beliefs are revised as a result of their relationships with *disease severity* as captured in the intuitive theory. To examine this, we used the same model developed in Study 1 to simulate how the 13 other beliefs in the intuitive theory would change if we intervened directly on *disease severity* (see Methods). As shown in Figure 3, this simulation is a reasonable approximation of what we observed in Study 2: The model’s predictions correlate strongly with observed changes (*r* = `r results$s2$modcorr`). 
...
To examine this possibility, we invited participants from Study 1 (conducted in September 2017) to participate in a new study measuring each of those 14 beliefs again (conducted on May 1st, 2019; approximately 18 months later). Of the `r results$s1$demo$n_include` participants in Study 1, `r results$s4$demo$n_complete` returned and completed the study. Approximately `r round(100*(results$s4$demo$n_news/results$s4$demo$n_complete),0) `% of participants reported recently seeing, hearing, or reading about measles outbreaks.
...
Study 3a and 3b tested the effects of a novel intervention aimed at dispelling concerns about toxic additives in vaccines. These studies followed similar design procedures as Study 2, with phase 2 conducted 1-2 days after phase 1. In both Study 3a (April 2019) and Study 3b (May 2019; combined final *n* = `r results$s3$demo$n_complete`) the vaccine toxin intervention was compared against no-intervention control.
...
We contacted as many of the `r results$s1$demo$n_include` participants who completed Study 1 as we could and invited them to participate in Study 4, in which they completed the same 14 belief scales and answered questions about their exposure to media coverage of the measles outbreaks. A total of `r results$s4$demo$n_recruited` participants returned and `r results$s4$demo$n_complete` successfully completed the study including passing attention checks. These participants completed all 14 belief scales and also indicated whether they had seen or heard anything about measles in the news recently.
...
Mirroring our analyses of interventions, we regressed responses to the *vaccine intentions* scale items on predictors for phase (September 2017 vs. May 2019, dummy-coded), news exposure (dummy-coded with non-exposure as the baseline), and an interaction between phase and news exposure onto participants’ scores, using a Bayesian mixed-effects ordinal regression including random intercepts by subject and item. To assess the effects of recent news exposure on vaccine intentions, we examined the interaction between phase and news exposure. Participants’ vaccine intentions were increased by recent news exposure compared to their responses 18 months ago (interaction effect: $b$ = `r round(s4_reg$fixed[9,1],3)`, 95% CI: [`r round(s4_reg$fixed[9,3], 3)`, `r round(s4_reg$fixed[9,4], 3)`]); see Figure 6, panel A. 
